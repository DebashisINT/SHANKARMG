package com.breezeshankar.features.dashboard.presentation
...
import com.breezeshankar.*
import com.breezeshankar.R
import com.breezeshankar.app.*
import com.breezeshankar.app.NewFileUtils.browseDocuments
import com.breezeshankar.app.NewFileUtils.browsePDFDocuments
import com.breezeshankar.app.NewFileUtils.getExtension
import com.breezeshankar.app.domain.*
import com.breezeshankar.app.types.DashboardType
import com.breezeshankar.app.types.FragType
import com.breezeshankar.app.types.TopBarConfig
import com.breezeshankar.app.uiaction.DisplayAlert
import com.breezeshankar.app.utils.*
import com.breezeshankar.app.utils.AppUtils.Companion.isProfile
...
import com.breezeshankar.features.NewQuotation.*
import com.breezeshankar.features.NewQuotation.api.GetQuotRegProvider
import com.breezeshankar.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezeshankar.features.SearchLocation.SearchLocationFragment
import com.breezeshankar.features.SearchLocation.locationInfoModel
import com.breezeshankar.features.TA.ViewAllTAListFragment
import com.breezeshankar.features.achievement.AchievementFragment
import com.breezeshankar.features.activities.presentation.*
import com.breezeshankar.features.addAttendence.*
import com.breezeshankar.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezeshankar.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezeshankar.features.addAttendence.model.GetReportToFCMResponse
import com.breezeshankar.features.addAttendence.model.GetReportToResponse
import com.breezeshankar.features.addAttendence.model.Leave_list_Response
import com.breezeshankar.features.addorder.presentation.AddOrderFragment
...
import com.breezeshankar.features.addshop.presentation.AddShopFragment
import com.breezeshankar.features.addshop.presentation.OTPVerificationDialog
import com.breezeshankar.features.addshop.presentation.ScanImageFragment
import com.breezeshankar.features.addshop.presentation.ShowCardDetailsDialog
import com.breezeshankar.features.alarm.model.AlarmData
import com.breezeshankar.features.alarm.presetation.AttendanceReportFragment
import com.breezeshankar.features.alarm.presetation.PerformanceReportFragment
import com.breezeshankar.features.alarm.presetation.VisitReportDetailsFragment
import com.breezeshankar.features.alarm.presetation.VisitReportFragment
import com.breezeshankar.features.attendance.AttendanceFragment
import com.breezeshankar.features.attendance.api.AttendanceRepositoryProvider
import com.breezeshankar.features.attendance.model.AttendanceRequest
import com.breezeshankar.features.attendance.model.AttendanceResponse
import com.breezeshankar.features.averageshop.presentation.AverageShopFragment
import com.breezeshankar.features.avgorder.presentation.AverageOrderFragment
import com.breezeshankar.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezeshankar.features.beatCustom.TeamBeatListFragment
import com.breezeshankar.features.billing.presentation.AddBillingFragment
import com.breezeshankar.features.billing.presentation.BillingDetailsFragment
import com.breezeshankar.features.billing.presentation.BillingListFragment
import com.breezeshankar.features.changepassword.presentation.ChangePasswordDialog
import com.breezeshankar.features.chat.model.ChatListDataModel
import com.breezeshankar.features.chat.model.ChatUserDataModel
import com.breezeshankar.features.chat.model.GroupUserDataModel
import com.breezeshankar.features.chat.presentation.*
import com.breezeshankar.features.chatbot.presentation.ChatBotFragment
import com.breezeshankar.features.chatbot.presentation.ChatBotShopListFragment
import com.breezeshankar.features.chatbot.presentation.ReportsFragment
import com.breezeshankar.features.chatbot.presentation.SelectLanguageDialog
import com.breezeshankar.features.commondialog.presentation.CommonDialog
import com.breezeshankar.features.commondialog.presentation.CommonDialogClickListener
import com.breezeshankar.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezeshankar.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezeshankar.features.commondialogsinglebtn.OnDialogClickListener
import com.breezeshankar.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezeshankar.features.contacts.ActivityDtlsFrag
import com.breezeshankar.features.contacts.AddOpptFrag
import com.breezeshankar.features.contacts.ContactDtls
import com.breezeshankar.features.contacts.ContactGr
import com.breezeshankar.features.contacts.ContactsAddFrag
import com.breezeshankar.features.contacts.ContactsFrag
import com.breezeshankar.features.contacts.SchedulerAddFormFrag
import com.breezeshankar.features.contacts.SchedulerViewFrag
import com.breezeshankar.features.contacts.TemplateAddFrag
import com.breezeshankar.features.contacts.TemplateViewFrag
import com.breezeshankar.features.contacts.ViewCrmOpptFrag
import com.breezeshankar.features.dailyPlan.prsentation.AllShopListFragment
import com.breezeshankar.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezeshankar.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezeshankar.features.damageProduct.ShopDamageProductListFrag
import com.breezeshankar.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezeshankar.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezeshankar.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezeshankar.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezeshankar.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezeshankar.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezeshankar.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezeshankar.features.dashboard.presentation.model.ContentListResponseModel
import com.breezeshankar.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezeshankar.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezeshankar.features.device_info.presentation.DeviceInfoListFragment
import com.breezeshankar.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezeshankar.features.document.DocumentRepoFeatureNewFragment
import com.breezeshankar.features.document.presentation.DocumentListFragment
import com.breezeshankar.features.document.presentation.DocumentTypeListFragment
import com.breezeshankar.features.document.presentation.OpenFileWebViewFragment
import com.breezeshankar.features.dymanicSection.presentation.AddDynamicFragment
import com.breezeshankar.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezeshankar.features.dymanicSection.presentation.DynamicListFragment
import com.breezeshankar.features.dymanicSection.presentation.EditDynamicFragment
import com.breezeshankar.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezeshankar.features.home.presentation.HomeFragment
import com.breezeshankar.features.homelocation.presentation.HomeLocationFragment
import com.breezeshankar.features.homelocation.presentation.HomeLocationMapFragment
import com.breezeshankar.features.know_your_state.KnowYourStateFragment
import com.breezeshankar.features.lead.LeadFrag
import com.breezeshankar.features.lead.ViewLeadFrag
import com.breezeshankar.features.leaderboard.LeaderBoardFrag
import com.breezeshankar.features.leaveapplynew.LeaveHome
import com.breezeshankar.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezeshankar.features.localshops.LocalShopListFragment
import com.breezeshankar.features.localshops.LocalShopListMapFragment
import com.breezeshankar.features.localshops.NearByShopsMapFragment
import com.breezeshankar.features.location.*
import com.breezeshankar.features.location.api.LocationRepoProvider
import com.breezeshankar.features.location.model.*
import com.breezeshankar.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezeshankar.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezeshankar.features.login.ShopFeedbackEntity
import com.breezeshankar.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezeshankar.features.login.presentation.LoginActivity
import com.breezeshankar.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezeshankar.features.logoutsync.presentation.LogoutSyncFragment
import com.breezeshankar.features.marketAssist.MarketAssistTabFrag
import com.breezeshankar.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezeshankar.features.marketAssist.ShopListMarketAssistFrag
import com.breezeshankar.features.marketing.presentation.MarketingPagerFragment
import com.breezeshankar.features.meetinglist.prsentation.MeetingListFragment
import com.breezeshankar.features.member.MapViewForTeamFrag
import com.breezeshankar.features.member.model.TeamLocDataModel
import com.breezeshankar.features.member.model.TeamShopListDataModel
import com.breezeshankar.features.member.presentation.*
import com.breezeshankar.features.menuBeat.MenuBeatFrag
import com.breezeshankar.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezeshankar.features.micro_learning.presentation.MicroLearningListFragment
import com.breezeshankar.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezeshankar.features.myallowancerequest.MyallowanceRequestFragment
import com.breezeshankar.features.myjobs.model.CustomerDataModel
import com.breezeshankar.features.myjobs.presentation.*
import com.breezeshankar.features.mylearning.MyLearningFragment
import com.breezeshankar.features.myorder.presentation.MyOrderListFragment
import com.breezeshankar.features.myprofile.presentation.MyProfileFragment
import com.breezeshankar.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezeshankar.features.nearbyshops.model.ShopData
import com.breezeshankar.features.nearbyshops.model.ShopListResponse
import com.breezeshankar.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezeshankar.features.nearbyshops.presentation.BeatListFragment
import com.breezeshankar.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezeshankar.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezeshankar.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezeshankar.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezeshankar.features.newcollection.CollectionDetailsStatusFragment
import com.breezeshankar.features.newcollection.CollectionShopListFragment
import com.breezeshankar.features.newcollection.NewCollectionListFragment
import com.breezeshankar.features.newcollectionreport.*
import com.breezeshankar.features.notification.NotificationFragment
import com.breezeshankar.features.orderITC.CartListFrag
import com.breezeshankar.features.orderITC.OrderListFrag
import com.breezeshankar.features.orderITC.ProductListFrag
import com.breezeshankar.features.orderITC.ViewNewOrdHisAllFrag
import com.breezeshankar.features.orderITC.ViewNewOrdHistoryFrag
import com.breezeshankar.features.orderITC.ViewOrdDtls
import com.breezeshankar.features.orderList.NewDateWiseOrderListFragment
import com.breezeshankar.features.orderList.NewOrderListFragment
import com.breezeshankar.features.orderList.OrderListFragment
import com.breezeshankar.features.orderdetail.presentation.OrderDetailFragment
import com.breezeshankar.features.orderhistory.ActivityMapFragment
import com.breezeshankar.features.orderhistory.OrderhistoryFragment
import com.breezeshankar.features.orderhistory.TimeLineFragment
import com.breezeshankar.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezeshankar.features.orderhistory.model.FetchLocationRequest
import com.breezeshankar.features.orderhistory.model.FetchLocationResponse
import com.breezeshankar.features.orderhistory.model.LocationData
import com.breezeshankar.features.pendinglocationinout.PendingOutLocationFrag
import com.breezeshankar.features.performance.GpsStatusFragment
import com.breezeshankar.features.performance.PerformanceFragment
import com.breezeshankar.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezeshankar.features.performance.model.UpdateGpsInputParamsModel
import com.breezeshankar.features.performanceAPP.OwnPerformanceFragment
import com.breezeshankar.features.performanceAPP.PerformanceAppFragment
import com.breezeshankar.features.performanceAPP.allPerformanceFrag
import com.breezeshankar.features.permissionList.ViewPermissionFragment
import com.breezeshankar.features.photoReg.*
import com.breezeshankar.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezeshankar.features.quotation.presentation.*
import com.breezeshankar.features.reimbursement.presentation.*
import com.breezeshankar.features.report.presentation.*
import com.breezeshankar.features.returnsOrder.*
import com.breezeshankar.features.settings.presentation.SettingsFragment
import com.breezeshankar.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezeshankar.features.shopdetail.presentation.*
import com.breezeshankar.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezeshankar.features.stock.StockDetailsFragment
import com.breezeshankar.features.stock.StockListFragment
import com.breezeshankar.features.stockAddCurrentStock.AddShopStockFragment
import com.breezeshankar.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezeshankar.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezeshankar.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezeshankar.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezeshankar.features.stockCompetetorStock.CompetetorStockFragment
import com.breezeshankar.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezeshankar.features.survey.SurveyFrag
import com.breezeshankar.features.survey.SurveyViewDtlsFrag
import com.breezeshankar.features.survey.SurveyViewFrag
import com.breezeshankar.features.task.presentation.AddTaskFragment
import com.breezeshankar.features.task.presentation.CalenderTaskFragment
import com.breezeshankar.features.task.presentation.EditTaskFragment
import com.breezeshankar.features.task.presentation.TaskListFragment
import com.breezeshankar.features.taskManagement.TaskManagementFrag
import com.breezeshankar.features.taskManagement.ViewTaskManagementFrag
import com.breezeshankar.features.timesheet.presentation.AddTimeSheetFragment
import com.breezeshankar.features.timesheet.presentation.EditTimeSheetFragment
import com.breezeshankar.features.timesheet.presentation.TimeSheetListFragment
import com.breezeshankar.features.viewAllOrder.CartFragment
import com.breezeshankar.features.viewAllOrder.OrderTypeListFragment
import com.breezeshankar.features.viewAllOrder.ViewAllOrderListFragment
import com.breezeshankar.features.viewAllOrder.ViewCartFragment
import com.breezeshankar.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezeshankar.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezeshankar.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezeshankar.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezeshankar.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezeshankar.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezeshankar.features.viewPPDDStock.ViewOutstandingFragment
import com.breezeshankar.features.viewPPDDStock.ViewPPDDListFragment
import com.breezeshankar.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezeshankar.features.viewPPDDStock.ViewStockFragment
import com.breezeshankar.features.weather.presentation.WeatherFragment
import com.breezeshankar.mappackage.MapActivity
import com.breezeshankar.mappackage.MapActivityWithoutPath
import com.breezeshankar.mappackage.SendBrod
import com.breezeshankar.widgets.AppCustomEditText
import com.breezeshankar.widgets.AppCustomTextView
...
import com.breezeshankar.features.login.api.opportunity.OpportunityRepoProvider
import com.breezeshankar.features.mylearning.BookmarkFrag
import com.breezeshankar.features.mylearning.KnowledgeHubAllVideoList
import com.breezeshankar.features.mylearning.LeaderboardLmsFrag
import com.breezeshankar.features.mylearning.LmsQuestionAnswerSet
import com.breezeshankar.features.mylearning.MyLearningAllVideoList
import com.breezeshankar.features.mylearning.MyLearningTopicList
import com.breezeshankar.features.mylearning.MyLearningVideoPlay
import com.breezeshankar.features.mylearning.MyPerformanceFrag
import com.breezeshankar.features.mylearning.NotificationLMSFragment
import com.breezeshankar.features.mylearning.SearchLmsFrag
import com.breezeshankar.features.mylearning.SearchLmsKnowledgeFrag
import com.breezeshankar.features.mylearning.SearchLmsLearningFrag
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezeshankarlogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeshankarlogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezeshankar/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezeshankarlogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezeshankarlogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezeshankarlogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
