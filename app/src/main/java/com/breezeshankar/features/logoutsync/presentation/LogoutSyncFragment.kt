package com.breezeshankar.features.logoutsync.presentation
...
import com.breezeshankar.app.AppDatabase
...
import com.breezeshankar.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezeshankar.features.billing.api.AddBillingRepoProvider
import com.breezeshankar.features.billing.model.AddBillingInputParamsModel
...
import com.breezeshankar.features.dashboard.presentation.ReasonDialog
...
import com.breezeshankar.features.document.model.AddEditDocumentInputParams
import com.breezeshankar.features.document.model.DocumentAttachmentModel
...
import com.breezeshankar.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezeshankar.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezeshankar.features.orderhistory.model.*
...
import com.breezeshankar.features.quotation.model.AddQuotInputModel
import com.breezeshankar.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezeshankar.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezeshankar.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezeshankar.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezeshankar.features.timesheet.model.AddTimeSheetInputModel
import com.breezeshankar.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezeshankar.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezeshankar.features.viewAllOrder.model.AddOrderInputProductList
import com.breezeshankar.mappackage.SendBrod
import com.breezeshankar.widgets.AppCustomTextView
import com.breezeshankar.MonitorService
import com.breezeshankar.MySingleton
import com.breezeshankar.app.AlarmReceiver
import com.breezeshankar.features.addshop.model.*
import com.breezeshankar.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezeshankar.features.addshop.presentation.ShopExtraContactReq
import com.breezeshankar.features.addshop.presentation.multiContactRequestData
import com.breezeshankar.features.contacts.CallHisDtls
import com.breezeshankar.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezeshankar.features.login.model.GetConcurrentUserResponse
import com.breezeshankar.features.login.model.WhatsappApiData
import com.breezeshankar.features.orderITC.SyncDeleteOppt
import com.breezeshankar.features.orderITC.SyncDeleteOpptL
import com.breezeshankar.features.orderITC.SyncEditOppt
import com.breezeshankar.features.orderITC.SyncOppt
import com.breezeshankar.features.orderITC.SyncOpptProductL
import com.breezeshankar.features.orderITC.SyncOrd
import com.breezeshankar.features.orderITC.SyncOrdProductL
import com.breezeshankar.features.performance.model.Gps_status_list
import com.breezeshankar.features.performance.model.UpdateGpsInputListParamsModel
import com.breezeshankar.features.returnsOrder.ReturnProductList
import com.breezeshankar.features.returnsOrder.ReturnRequest
import com.breezeshankar.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeshankarlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeshankarlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeshankarlogsample/log.zip").path);
